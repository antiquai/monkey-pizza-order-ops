...
export default function ProductCard({product, onAdd}: Props) {
    return (
    <Card className="group relative overflow-hidden rounded-md border-none bg-white transition-all duration-300 hover:shadow-2xl hover:-translate-y-1">
      ...
      <div className="relative aspect-[4/5] w-3/4 overflow-hidden bg-white p-6 flex justify-center items-center mx-auto">
        ...
        {/* Маленький бейдж (например, New или цена) — опционально */}
