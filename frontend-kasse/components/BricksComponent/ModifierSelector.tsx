...
import { Product, Modifier } from "../Catalog";
...
interface Props {
    ...
    isOpen: boolean;
    onClose: () => void;
    onConfirm: (selectModifiers: Modifier[]) => void;
}
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-106.25 p-0 overflow-hidden border-none text-black">
                ...
                <div className="flex justify-between items-center p-6 border-t bg-zinc-50">
                    ...
                    <Button 
                        onClick={handleSave} 
                        className="relative overflow-hidden rounded-none bg-black px-12 py-6 text-sm font-bold uppercase tracking-widest text-white transition-all hover:bg-zinc-800 active:scale-[0.98]"
                    >
                        Confirm
                    </Button>
                </div>
